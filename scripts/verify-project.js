...
assertIncludes("scripts/package-extensions.ps1", "Package JetBrains plugin");
assertIncludes("scripts/package-extensions.ps1", ".tmp-jetbrains-build");
assertIncludes("scripts/package-extensions.ps1", "kotlin.compiler.execution.strategy=in-process");
assertIncludes("scripts/package-extensions.ps1", "--allow-missing-repository");
...
assertIncludes("scripts/package-extensions.ps1", "ContextToAgent.VisualStudio.dll");
